## Stripe API
Before we begin using Pro Plans, we need to create an account from [Stripe](https://stripe.com/) to get API keys and secret keys for Cashier.  
...
![stripe dashboard api keys page](https://weeklyhow.com/wp-content/uploads/2020/09/image-6-1024x449.png)
...
![stripe](https://weeklyhow.com/wp-content/uploads/2020/09/image-8.png)
[![stripe](https://weeklyhow.com/wp-content/uploads/2020/09/image-18.png)
A form should pop up as soon as you press the add product button.
* GO to Settings -> SEO Configuration
* Update the Stripe ID, Billing Period and the price to match the values currently set in Stripe.
Once you’re done filling up the form, you can save by clicking the Save 
